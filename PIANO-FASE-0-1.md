...
| 0.5 | **Campione documenti** | 30-50 documenti veri non sensibili — **i peggiori che ci sono, non i più belli**. Ripartizione e regole di raccolta in `documenti_test/ESEMPI-FILE-DOCUMENTI.md` §2 | I PDF finti non hanno tabelle ruotate né scansioni storte. Se il campione è pulito, il test mente |
