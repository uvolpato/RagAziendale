...
- [ ] **No remote image dependencies.** Every used image is embedded as a data URI in the artifact HTML. No hotlinks, expiring URLs, broken sources, or unlabeled `.ph-img` scaffolds remain.
